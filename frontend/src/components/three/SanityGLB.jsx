   ...
   return (
      <div className="relative flex flex-wrap flex-col-reverse lg:flex-row-reverse justify-center w-full h-auto border border-gray-600 mb-20">
         ...
         <div className="w-full lg:w-3/4 flex lg:h-[90vh] h-[70vh] shadow-md border-b  lg:border-b-0 lg:border-r border-gray-600">
            <Canvas camera={{ position: [0.5, 0.4, 1], fov: 75 }} style={{ height: 'full', width: '100vw' }}>
               <OrbitControls />
               <pointLight
                  intensity={5}
                  position={[0, 1, 0]} // UP
...
const Description = () => {
   return (
      <div className="w-full lg:w-1/4 font-mono flex flex-col h-full p-6 b border-b border-gray-600 shadow-lg ">
         ...
         <h2 className="text-black  text-3xl font-extrabold mb-2 leading-tight">GLB Sanity Model</h2>
         <p className="text-black  text-sm leading-tight mb-12 opacity-80">This model was made in Spline, exported as a .glb file, and uploaded to Sanity. This is a proof of concept for using Sanity as a CMS for 3D objects. The animation can also be controlled from Sanity.</p>
         <h3 className="text-gray-200   text-lg font-bold mb-2 leading-snug">Use Cases</h3>
