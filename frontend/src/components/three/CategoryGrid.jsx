   ...
   return (
      <div className="relative flex flex-wrap flex-col-reverse lg:flex-row-reverse justify-center  w-full h-auto   border border-gray-600 mb-20 ">
         ...
         <div className="w-full lg:w-3/4 flex lg:h-[90vh] h-[70vh] shadow-md border-b  lg:border-b-0 lg:border-r border-gray-600">
            <Canvas camera={{ position: [0, 0, 40], fov: 45 }} style={{ height: 'full', width: '100vw' }}>
               <OrbitControls />
...
const Description = () => {
   return (
      <div className="w-full lg:w-1/4 font-mono flex flex-col h-full p-8 b border-b border-gray-600 shadow-lg ">
         ...
         <h2 className="text-black text-3xl font-extrabold mb-2 leading-tight">Topic Exploration</h2>
         <p className="text-black  text-sm leading-tight mb-12 opacity-80">A spatial representation of each topic with hover effects to reveal related topics.</p>
         ...
         <ul className="text-black   text-sm mb-2 leading-tight pl-8 list-disc opacity-80">
            <li className="mb-1">Explore topics and subtopics in a spatial representation, with popover and hover effects to reveal content.</li>
         </ul>
