   ...
   return (
      <div className="flex w-full items-center justify-center mb-8 ">
         <div className="relative md:w-4/5 lg:w-1/2 w-11/12 border bg-black rounded-2xl border-gray-600">
            <div className="absolute inset-0 z-10">{media?.image && <img src={getSanityImageURL(media.image).url()} alt="image" className="h-full w-full opacity-40  object-cover rounded-2xl" />}</div>
