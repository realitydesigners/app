    ...
    <div className="flex w-full  items-center justify-center p-4 mb-8 lg:p-12">
      <div className=" bg-gray-300 w-full rounded-xl md:w-1/2 group flex h-auto flex-row p-4 shadow-lg transition-shadow duration-300 hover:shadow-xl lg:w-3/5">
        ...
        <div className="relative flex w-3/4 flex-col pl-4">
          <p className="mt-2 font-rajdhani text-xs uppercase leading-none tracking-wide text-black">
            Related Post
          </p>
          <a
            className="duration-3 scramble-title font-rajdhani leading-5 text-xl md:text-2xl tracking-wide text-black transition-colors group-hover:text-gray-800 group-hover:underline"
            href={`/posts/${slug}`}
          >
            {title}
          </a>
